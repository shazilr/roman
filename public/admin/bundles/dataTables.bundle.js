...
$jscomp.polyfill = function(t, e, n, a) {
    ...
    function(n) {
        ...
        function ct(t) {
            for (var e = t.aoColumns, n = e.length, a = t.oFeatures, r = t.oPreviousSearch, o = t.aoPreSearchCols, i = [], s = w(t), l = t._iDisplayStart, c = !1 !== a.bPaginate ? t._iDisplayLength : -1, u = function(t, e) {
                    i.push({
                        name: t,
                        value: e
                    })
                }, d = (u("sEcho", t.iDraw), u("iColumns", n), u("sColumns", H(e, "sName").join(",")), u("iDisplayStart", l), u("iDisplayLength", c), {
                    draw: t.iDraw,
                    columns: [],
                    order: [],
                    start: l,
                ...
                var f = e[l],
                    h = o[l],
                    c = "function" == typeof f.mData ? "function" : f.mData;
                d.columns.push({
                    data: c,
                    name: f.sName,
                ...
                }), u("mDataProp_" + l, c), a.bFilter && (u("sSearch_" + l, h.sSearch), u("bRegex_" + l, h.bRegex), u("bSearchable_" + l, f.bSearchable)), a.bSort && u("bSortable_" + l, f.bSortable)
            }
            return a.bFilter && (u("sSearch", r.sSearch), u("bRegex", r.bRegex)), a.bSort && (P.each(s, function(t, e) {
                d.order.push({
                    column: e.col,
                    dir: e.dir
                }), u("iSortCol_" + t, e.col), u("sSortDir_" + t, e.dir)
            }), u("iSortingCols", s.length)), null === (e = A.ext.legacy.ajax) ? t.sAjaxSource ? i : d : e ? i : d
        }
        ...
        function fe(t, e, n, a) {
            return 0 === t || t && "-" !== t ? +(t = (t = e ? Se(t, e) : t).replace && (n && (t = t.replace(n, "")), a) ? t.replace(a, "") : t) : -1 / 0
        }
        ...
        P.extend(Re, {
            ...
            pageButton: {
                _: function(l, t, c, e, u, d) {
                    function f(t, e) {
                        for (var n = g.sPageButtonDisabled, a = function(t) {
                            ...
                            if (Array.isArray(i)) {
                                ...
                                switch (h = null, p = i, s = l.iTabIndex, i) {
                                    case "ellipsis":
                                        ...
                                        break;
                                    case "first":
                                        h = b.sFirst, 0 === u && (s = -1, p += " " + n);
                                        break;
                                    case "previous":
                                        h = b.sPrevious, 0 === u && (s = -1, p += " " + n);
                                        break;
                                    case "next":
                                        h = b.sNext, 0 !== d && u !== d - 1 || (s = -1, p += " " + n);
                                        break;
                                    case "last":
                                        h = b.sLast, 0 !== d && u !== d - 1 || (s = -1, p += " " + n);
                                        break;
                                    default:
