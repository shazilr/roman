            ...
            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                ...
                <div class="dropdown zindex-popover">
                    <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="dropdown">
                        <img src="{{asset('admin/images/flag/GB.png')}}" alt="">
                    </a>
                    <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0 mt-3">
                        <div class="card border-0">
                            <ul class="list-unstyled py-2 px-3">
                                <li>
                                    <a href="#" class=""><img src="{{asset('admin/images/flag/GB.png')}}" alt=""> English</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{asset('admin/images/flag/DE.png')}}" alt=""> German</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{asset('admin/images/flag/FR.png')}}" alt=""> French</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{asset('admin/images/flag/IT.png')}}" alt=""> Italian</a>
                                </li>
                                <li>
                                    <a href="#" class=""><img src="{{asset('admin/images/flag/RU.png')}}" alt=""> Russian</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <ul class="list-unstyled list mb-0">
                                        <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle" src="{{asset('admin/images/xs/avatar1.svg')}}" alt="">
                    ...
                    <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                        <div class="card border-0 w280">
                            ...
                            <div class="list-group m-2 ">
                                <a href="{{route('admin.profile')}}" class="list-group-item list-group-item-action border-0 "><i class="icofont-ui-user fs-5 me-3"></i>Profile Page</a>
